...
```
i create a function: (1) create a data frame of normally distributed data (set n=30 and sigma(sd)=5). (2) save mu_hat and the p-value arising from a test of H:μ=0 using α=0.05 with this data frame.
